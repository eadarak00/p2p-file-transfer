...
public class Client1 {
    ...
    private Client1(String pseudo, String adresse, int port, String dossierBase) {
        this.pseudo = pseudo;
    ...
    public static synchronized Client1 getInstance(String pseudo, String adresse, int port, String dossierBase) {
        if (instance == null) {
            instance = new Client1(pseudo, adresse, port, dossierBase);
        }
        return instance;
    }
